...
/**
 * Screen that shows that online play has yet to be
 * implemented by outputting a simple label.
 *
 * @author Michael Imerman 100%
 */
public class OnlinePlayScreen extends Pane {
    ...
    /**
     * Label to display a message that online play is not implemented yet.
     */
    final Label message;
    ...
    /**
     * Constructor that creates the label for the screen of the
     * unimplemented player vs computer.
     */
    public OnlinePlayScreen() {
        root = new AnchorPane();

        message = new Label("Online Play has yet to be implemented!");
