...
/**
 * Screen that shows that showing rules has yet to be
 * implemented by outputting a simple label.
 *
 * @author Michael Imerman 100%
 */
public class RulesScreen extends Pane {
    ...
    /**
     * Label to display a message that rules of the game is not implemented yet.
     */
    final Label message;
    ...
    public RulesScreen() {
        ...
        message = new Label("The rules screen has yet to be implemented!");
